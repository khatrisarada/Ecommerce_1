...
const ImageList = [
  {
    ...
    description:
      "sydgsudhijknj dfs7dsu ysdvsjxkudu suycvsjn sdfwgedicsjk dgcshidckxjsj ss schsidx.",
  },
  {
    id: 2,
    img: Image2,
    ...
    description:
      "dfsygu asgsu sdis cbhsjcdu d7wdy9qu s gysdgs 8yd98wduj dgsij xys doisx uc sywid ucya8eujsc xs u",
  },
  {
    id: 3,
    img: Image3,
    title: "70% off all products Sale",
    description: "asxsu dgusd scvs casudhs dygiud ccsshio ddcuycgsidcs ",
  },
];
